...
final class StoreAtendimentoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'paciente_nome' => ['required', 'string', 'min:1'],
            ...
            'exames.*.solicitante' => ['sometimes', 'string'],
            ...
            'pagamentos.*.tipo' => ['required_with:pagamentos', 'string', 'min:1'],
            'pagamentos.*.valor' => ['required_with:pagamentos', 'numeric', 'min:0'],
